  ...
  return (
    <div className="bg-background">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-4xl">
        <article className="bg-card p-6 sm:p-8 md:p-10 rounded-lg shadow-xl animate-fade-in">
          {post.image && (
            <div className="relative aspect-video mb-8 rounded-md overflow-hidden animate-fade-in">
              <Image
                src={post.image}
                alt={post.title}
                fill
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-3 items-center mb-6 text-sm text-muted-foreground animate-fade-in-down animation-delay-200">
          ...
          <div
            className="prose prose-lg dark:prose-invert max-w-none text-foreground/90 leading-relaxed animate-fade-in-up animation-delay-300"
          ...
          {post.tags && post.tags.length > 0 && (
            <>
              ...
              <div className="flex items-center flex-wrap gap-2 animate-fade-in-up animation-delay-400">
